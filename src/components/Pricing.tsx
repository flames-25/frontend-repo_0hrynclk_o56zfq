          ...
          {tiers.map((tier) => (
            <div
              ...
              className={
                ...
                (tier.highlighted
                  ? 'border-amber-200 bg-white ring-1 ring-amber-200'
                  : 'border-gray-200 bg-white hover:shadow-md')
              }
            >
              {tier.highlighted && (
                <span className="absolute -top-3 left-8 rounded-full bg-amber-500 px-2 py-1 text-xs font-semibold text-black">Best value</span>
              )}
